...
fnc_setPNS = compileFinal 'profileNamespace setVariable _this;saveProfileNamespace;';
fnc_getPNS = compileFinal 'profileNamespace getVariable _this';
fnc_lbDebugChanged = {
...
infiSTAR_adminConsoleInit = {
if(isNil'ADMINLEVELACCESS')exitWith{};
if(!('AdminConsole' call ADMINLEVELACCESS))exitWith{};
...
_listbox = [findDisplay -1341,'RscListBox_infiSTAR',1384] call fnc_createctrl;
_listbox ctrlSetPosition [-0.25,safeZoneY + 0.61,0.25,safeZoneH * 0.4935];
